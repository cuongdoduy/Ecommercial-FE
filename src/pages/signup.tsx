  ...
  return (
    <>
      ...
      <main className="relative">
        <div className="grid place-items-center bg-[#F7F7F7]">
          <div className="w-fit grid place-items-center my-[80px]">
            <header className="flex items-center justify-start flex-wrap">
              <h4 className="text-h4 font-bold mr-4 text-center">Sign up to</h4>
              <Link href="/">
